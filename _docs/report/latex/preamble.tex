...
% Architecture diagrams are drawn rather than imported, so they stay editable and match the
% document fonts. Compiles on the Overleaf free plan; the diagrams here are small.
\usepackage{tikz}
