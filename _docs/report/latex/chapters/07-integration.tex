...
\begin{enumerate}
  \item \textbf{Each agent is independently testable.} The reasoning agent can be exercised
        ...
        322 tests of Section~\ref{subsec:reasoning-safety} run --- in seconds, with no GPU and
        no model weights.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{llX}
    ...
    \midrule
    \texttt{pytest} & 322 pass & does the system behave as specified \\
    safety benchmark & 322 pass & the same tests, grouped by the property each exercises \\
