...
\begin{figure}[H]
  ...
  \begin{verbatim}
          ...
          reproducible training
                  |
          evaluation (fixed protocol)
                  |
          register candidate  --> MLflow
                  |
              safety gate
              /         \
           FAIL         PASS
  ...
  \end{verbatim}
  \end{minipage}
  \caption{The model-update lifecycle. No path leads from contributed data to a deployed
  model without a person in it.}
  \label{fig:mlops}
\end{figure}
