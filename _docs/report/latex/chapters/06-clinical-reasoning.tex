...
These rules are exercised by 236 automated tests, grouped by the property each one
...
The safety layer behaved as specified on five designed cases and on 236 automated tests.
