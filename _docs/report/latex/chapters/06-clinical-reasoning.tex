...
Separating the branches is the central design choice. If the model crashes, escalation
still exists. If retrieval finds nothing, escalation still exists. If the model invents
evidence, the validator withholds the differential and the escalation is still reported.
This was tested directly with a backend made to fail: the escalation decision and its
triggers were produced unchanged, and the differential was withheld with the backend error
recorded.
