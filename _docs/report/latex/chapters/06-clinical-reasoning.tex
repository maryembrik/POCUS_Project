...
These rules are exercised by 339 automated tests, grouped by the property each one
...
The safety layer behaved as specified on five designed cases and on 339 automated tests.
