...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[gen, below right=12mm and -14mm of state] (rag) {%
      \textbf{Retrieval}\\ TF--IDF, 30 units};
...
These rules are exercised by 209 automated tests, grouped by the property each one
...
The safety layer behaved as specified on five designed cases and on 209 automated tests.
