...
than asserted: 236 tests exercise it with no model present, and the decision was verified
...
about software, evidenced by 236 tests. \emph{Deterministic safety controls} names a property
