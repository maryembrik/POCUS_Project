...
than asserted: 228 tests exercise it with no model present, and the decision was verified
...
about software, evidenced by 228 tests. \emph{Deterministic safety controls} names a property
