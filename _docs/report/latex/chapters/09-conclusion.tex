...
than asserted: 322 tests exercise it with no model present, and the decision was verified
...
about software, evidenced by 322 tests. \emph{Deterministic safety controls} names a property
