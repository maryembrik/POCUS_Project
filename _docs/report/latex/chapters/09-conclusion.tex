...
than asserted: 209 tests exercise it with no model present, and the decision was verified
...
about software, evidenced by 209 tests. \emph{Deterministic safety controls} names a property
...
Four obstacles shaped the method rather than merely delaying it.
