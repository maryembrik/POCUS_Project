...
than asserted: 335 tests exercise it with no model present, and the decision was verified
...
about software, evidenced by 335 tests. \emph{Deterministic safety controls} names a property
