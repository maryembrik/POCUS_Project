...
src/agents/
  ...
  triage/                Triage Agent
  ultrasound/            Ultrasound Agent (routing; inference in notebooks)
  clinical/              Clinical Reasoning Agent
    ...
    corpus/                30 sourced knowledge units
    run_case.py            five benchmark scenarios, end to end
  tests/                 180 tests, grouped by safety property
notebooks/               training and inference, one per organ
...
\paragraph{Reproducing the safety benchmark.} The 180 tests require no GPU, no model weights and
no dataset:
